...
import {
 ...
 const AccountEdit = props => {
    ...
    const handleSubmit = e => {
      e.preventDefault();
      API.editArtist({artist_name,description,image_url,portfolio,username,password})
        .then(user => {
          console.log(user);
        ...
        <div className="ui fluid card">
          <div className="content">
            <form onSubmit={handleSubmit} className="ui form">
              <div className="field">
              <input type="text" placeholder="Username" name="username"value={props.username}
        ...
        <div className="field">
          <input type="url" placeholder="Portfolio Link" name="portfolio" value={portfolio}
            onChange={e => setPortfolio(e.target.value)}/>
              ...
              <input type="submit" value="Submit Editions"/>
              </div>
            </form>
          </div>
        </div>
