  ...
  return (<div className="App">
    <div className='ui container'><NavBar artist={artist} logout={logout}/>
      <Switch>
        ...
        <Route exact="exact" path='/Events/:id' render={props => <EventPage {...props} chosenEvent={chosenEvent} setEventEdit={setEventEdit}/>}/>
        ...
        <Route exact="exact" path='/event/edit' component={props => <EventEdit {...props} {...eventEdit}/>}/>
